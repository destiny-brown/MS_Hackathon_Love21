          ...
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1.2fr]">
            <div className="space-y-6 text-brand-dark/80">
              <p>
                ...
                <Link href="/members" className="text-brand-red hover:underline">
                  fill out the form here
                </Link>
                . For volunteering, please check out the{" "}
                <Link href="/our-volunteer" className="text-brand-red hover:underline">
                  volunteer page
                </Link>{" "}
              ...
              <p>
                ...
                <a href="mailto:info@love21foundation.com" className="text-brand-red hover:underline">
                  info@love21foundation.com
                </a>
              </p>
              <div className="space-y-4 pt-4">
                <div>
                  <p className="font-semibold text-brand-dark">Love 21 Space</p>
                  <p>2/F, Trium Lab, 21 Luk Hop Street, San Po Kong, Kowloon</p>
                </div>
                <div>
                  <p className="font-semibold text-brand-dark">Love 21 Office (for correspondences)</p>
