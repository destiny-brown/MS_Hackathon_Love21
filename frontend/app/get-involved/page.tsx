...
const testimonials = [
  {
    quote:
      "Two years ago, [Name] couldn't finish a lap. This season, [she/he] led the warm-up.",
    name: "[Parent name], mother of a Saturday football member",
  },
  {
    quote:
      "I signed up for one Saturday shift. Eighteen months later I'm on the events committee.",
    name: "[Volunteer name], class volunteer since 2024",
  },
  {
    quote:
      "Our team came for a CSR morning. Half of us are still volunteering monthly.",
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="mt-5 text-sm font-semibold text-brand-dark/60">
          {active.name}
        </p>
      </div>
      ...
      {faqs.map((item, i) => {
        ...
        return (
          <div key={item.q} className="py-5">
            ...
            >
              <span className="font-serif-display text-lg text-brand-dark sm:text-xl">
                {item.q}
              </span>
              <span
  ...
  return (
    <SiteLayout>
          ...
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pr-16">
            <div className="relative">
              ...
              <p className="mt-6 max-w-lg text-lg text-brand-dark/75">
                Every month, 600+ Hong Kong families walk through our doors for
                sport, nutrition, and community — because someone showed up for
                them first. That someone could be you.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <CtaButton href="/donate">Donate</CtaButton>
                <CtaButton href="/our-volunteer" variant="outline">
                  Volunteer
                </CtaButton>
              </div>
            </div>
      ...
      <div className="relative overflow-hidden bg-brand-light">
        ...
        <section
          id="programmes"
          className="relative px-4 py-16 sm:px-6 lg:px-8 lg:pr-24"
        >
          <Reveal>
            <div className="mx-auto max-w-6xl">
              <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
                ...
                <p className="max-w-2xl text-sm text-brand-dark/70">
                  A whole-person model — sport, nutrition, and family support —
                  because reaching full potential takes more than one hour a
                  week.
                </p>
              </div>
            </div>
                ...
                <Reveal key={programme.title} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <div className="mt-5 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                      <Link
                        href="/members"
                        className="rounded-md font-semibold text-brand-coral hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                      >
                        Join as a member
                      </Link>
                      <Link
                      ...
                      <Link
                        href="/donate"
                        className="rounded-md font-semibold text-brand-red hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                      >
                        Donate
                      </Link>
                    </div>
        ...
        <section className="relative px-4 pb-16 sm:px-6 lg:px-8 lg:pr-24">
          <div className="mx-auto max-w-6xl">
            <p className="flex items-center gap-2.5 text-xs font-semibold uppercase tracking-[0.15em] text-brand-dark/50">
              <IconHeart className="h-4 w-4" /> Life at Love 21, in between the
              numbers
            </p>
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {weeklyRhythm.map((slot) => (
                <div
                  key={slot.day + slot.programme}
                  className="rounded-2xl bg-white p-5 shadow-sm"
                >
                  <div className="text-xs font-semibold uppercase tracking-wide text-brand-red">
                    {slot.day}
                  </div>
                  <div className="mt-2 font-serif-display text-lg text-brand-dark">
                    {slot.programme}
                  </div>
            ...
            <p className="mt-4 text-xs text-brand-dark/50">
              Placeholder schedule — replace with your real weekly calendar
              before publishing.
            </p>
          </div>
        </section>
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                {journeySteps.map((step, i) => (
                  <Reveal
                    key={step.step}
                    delay={i * 0.1}
                    className="relative rounded-2xl border border-white/15 bg-white/[0.03] p-7"
                  >
      ...
      {/* ---------- NEWSLETTER / CLOSING ---------- */}
      <Reveal>
        <section className="relative overflow-hidden border-t border-brand-light bg-white px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto max-w-5xl">
            <BrandCard className="overflow-hidden border-brand-slate/15 bg-brand-light p-8 shadow-[0_18px_40px_rgba(43,45,66,0.08)] sm:p-10">
              <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-4 max-w-xl text-brand-dark/75">
                    Get Love 21 stories, programme updates, and event news
                    delivered straight to your inbox.
                  </p>
                </div>

                <div className="flex flex-col items-start gap-4 rounded-3xl bg-white p-6 ring-1 ring-brand-slate/10">
                  <TriMark className="h-2 w-7 text-brand-red" />
                  <p className="font-serif-display text-xl text-brand-dark">
                    Join the newsletter for updates worth opening.
                  </p>
                  <p className="text-sm leading-relaxed text-brand-dark/70">
                    It takes you to our newsletter page, where you can sign up
                    in a few seconds.
                  </p>
                  <Link
                    href="/newsletter"
                    className="inline-flex items-center justify-center rounded-full bg-brand-red px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-dark"
                  >
