...
{/* 
      ...
      <Reveal>
      <section id="campaign" className="scroll-mt-24 border-y border-brand-light bg-brand-light px-4 py-8 sm:px-6 lg:px-8">
      ...
      {/* ---------- OPPORTUNITIES BOARD ---------- */}
      <section id="opportunities" className="scroll-mt-24 bg-white px-4 py-16 sm:px-6 lg:px-8">
