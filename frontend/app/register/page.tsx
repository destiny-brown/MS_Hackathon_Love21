...
const registerableRoles: Array<{ value: Exclude<Role, "admin">; labelKey: string; descKey: string }> = [
  { value: "donor", labelKey: "register.donor", descKey: "register.donorDesc" },
  { value: "volunteer", labelKey: "register.volunteer", descKey: "register.volunteerDesc" },
  { value: "member", labelKey: "register.member", descKey: "register.memberDesc" },
];
              ...
              {registerableRoles.map((option) => (
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="block text-sm text-muted-foreground">{t(option.descKey)}</span>
                  </span>
                </label>
              ))}
            </fieldset>
