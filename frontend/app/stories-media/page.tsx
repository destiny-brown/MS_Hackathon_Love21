...
const abilityImages: Record<typeof abilityCardIds[number], typeof karateImage> = {
  karate: karateImage,
  "job-ready": scmpImage,
...
export default function StoriesMediaPage() {
  ...
  return (
    <SiteLayout>
      <PageHero
        title={t("hero.storiesMedia.title")}
        subtitle={t("hero.storiesMedia.subtitle")}
      />
      ...
      <section className="px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mb-8 max-w-2xl text-brand-ink/75 sm:ml-16">
            {t("sections.soMuchAbility.introStories")}
          </p>
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl space-y-12">
          <div className="rounded-2xl border border-brand-coral/30 bg-brand-cream/60 p-6 sm:p-8">
            <h2 className="font-serif-display text-2xl text-brand-ink">
              {t("sections.learnExperiences.title")}
            </h2>
          ...
          <div>
            <h2 className="font-serif-display text-3xl text-brand-ink">
              {t("sections.pressInterviews.title")}
            </h2>
            <p className="mt-1 text-sm text-brand-ink/65">
              {t("sections.pressInterviews.subtitle")}
            </p>
          ...
          <div>
            <h2 className="font-serif-display text-3xl text-brand-ink">
              {t("sections.communityEvents.title")}
            </h2>
